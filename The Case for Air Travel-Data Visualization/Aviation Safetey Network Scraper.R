...
year <- seq(from = 1919, to = 2021, 1) # data available from 1919 onwards
...
glimpse(aviationsafetynet_accident_data)

aviationsafetynet_accident_data$year <- str_sub(aviationsafetynet_accident_data$date,-4,-1)
aviationsafetynet_accident_data$accidents <- 1
aviationsafetynet_accident_data$fatalities <- as.numeric(as.character(aviationsafetynet_accident_data$fatalitie))
glimpse(aviationsafetynet_accident_data)

# Export data
write_xlsx(aviationsafetynet_accident_data,"accidentsbyyear.xlsx")
